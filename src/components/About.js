            ...
            <div className="container-xxl">
                ...
                <div className={`altar-level level-1 ${levelVisible === 1 ? 'visible' : 'hidden'}`}>
                    ...
                    <div className="mb-5 text-center">
                        <p className="text-google">Doing what you love is essential to maintain a balance between physical and mental health. That's why I prioritize some of my time to do my hobbies,
